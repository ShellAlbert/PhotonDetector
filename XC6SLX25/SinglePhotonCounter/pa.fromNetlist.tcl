...
create_project -name SinglePhotonCounter -dir "D:/Work/GitHub/PhotonDetector/XC6SLX25/SinglePhotonCounter/planAhead_run_1" -part xc6slx25ftg256-2
...
add_files [list {ipcore_dir/ZsyROM.ncf}] -fileset [get_property constrset [current_run]]
