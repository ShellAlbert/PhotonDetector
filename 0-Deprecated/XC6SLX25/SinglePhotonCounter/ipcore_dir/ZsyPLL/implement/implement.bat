...
xst -ifn xst.scr
move ZsyPLL_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ZsyPLL_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ZsyPLL_exdes.ucf ZsyPLL_exdes

echo 'Running map'
map -timing -pr b ZsyPLL_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm ZsyPLL_exdes -w routed.ncd routed.v
cd ..
