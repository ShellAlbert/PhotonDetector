...
vlog -work work ZsyPLL_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax ZsyPLL_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.ZsyPLL_tb work.glbl
