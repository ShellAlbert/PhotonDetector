...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ZLed_Indicator is
  ...
  signal \cnt_1mS[0]_i_27_n_0\ : STD_LOGIC;
  ...
  signal on_off_flag_reg_n_0 : STD_LOGIC;
...
begin
\cnt_1S[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"C8"
    )
        port map (
...
\cnt_1mS[0]_i_15\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
...
\cnt_1mS[0]_i_16\: unisim.vcomponents.LUT6
    generic map(
...
\cnt_1mS[0]_i_17\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\cnt_1mS[0]_i_27\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
on_off_flag_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
