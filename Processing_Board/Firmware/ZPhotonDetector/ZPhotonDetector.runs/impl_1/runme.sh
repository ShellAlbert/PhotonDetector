...
HD_PWD='F:/MyTemporary/Github/PhotonDetector/Processing_Board/Firmware/ZPhotonDetector/ZPhotonDetector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZPhotonDetector_Block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZPhotonDetector_Block_wrapper.tcl -notrace
