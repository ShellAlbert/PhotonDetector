...
HD_PWD='F:/MyTemporary/Github/PhotonDetector/Processing_Board/Firmware/ZPhotonDetector/ZPhotonDetector.runs/ZPhotonDetector_Block_ZEdge_Detect_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZPhotonDetector_Block_ZEdge_Detect_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZPhotonDetector_Block_ZEdge_Detect_0_0.tcl
