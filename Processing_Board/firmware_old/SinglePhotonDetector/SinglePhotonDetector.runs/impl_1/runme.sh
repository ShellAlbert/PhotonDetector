...
HD_PWD='F:/MyTemporary/Github/PhotonDetector/Processing_Board/firmware/SinglePhotonDetector/SinglePhotonDetector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZSinglePhotonDector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZSinglePhotonDector.tcl -notrace
