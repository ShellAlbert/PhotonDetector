...
HD_PWD='F:/MyTemporary/Github/PhotonDetector/Processing_Board/firmware/SinglePhotonDetector/SinglePhotonDetector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZSinglePhotonDector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZSinglePhotonDector.tcl
