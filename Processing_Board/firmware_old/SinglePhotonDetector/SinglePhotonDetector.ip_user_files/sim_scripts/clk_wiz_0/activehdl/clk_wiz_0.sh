...
#
# Script generated by Vivado on Mon Sep 25 10:35:34 +0800 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/MyTemporary/Github/PhotonDetector/Processing_Board/firmware/SinglePhotonDetector/SinglePhotonDetector.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
